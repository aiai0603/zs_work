		...
		<div id="all" align="center">
			<div class="nav">
				...
				<span  class="icon-2">
					...
					<div class="main">
						<form method="post" action="admin/yhSave2.asp?action=add" onsubmit="return check()" name="form1">
						<h2 style="font-size: 40px;margin-bottom: 20px;margin-right: 145px;">注册会员</h2>
						<div class="line">
							<div class="div1">用户名:</div>
							<div class="div2"><input type="text" name="zhanghao"></div>
							<div class="div3">4-20位字符，不支持汉字，支持字母和数字组合</div>
				
						</div>
						<div class="line">
							<div class="div1">请设置密码:</div>
							<div class="div2"><input type="text" name="mima"></div>
						...
						<div class="line">
							...
							<div class="div2"><input type="text" name="tele"></div>
