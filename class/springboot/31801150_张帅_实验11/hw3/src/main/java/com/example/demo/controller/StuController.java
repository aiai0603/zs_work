...
public class StuController {
    ...
    public ResponseData Stulist(@PathVariable("start") Integer start, HttpServletRequest request) {


        String token  = request.getHeader("token");
        if(PermitUtil.getPermit(token)==2){
            return new ResponseData(ExceptionMsg.PERMISSION,null);
        }else if(PermitUtil.getPermit(token)==0){
    ...
    public ResponseData getStu(@PathVariable("id") Integer id, HttpServletRequest request) {
            String token  = request.getHeader("token");
            if(PermitUtil.getPermit(token)==2){
                return new ResponseData(ExceptionMsg.PERMISSION,null);
            }else if(PermitUtil.getPermit(token)==0){
    ...
    public ResponseData getStu(@PathVariable("sid") String sid ,HttpServletRequest request) {
        String token  = request.getHeader("token");
        if(PermitUtil.getPermit(token)==2){
            return new ResponseData(ExceptionMsg.PERMISSION,null);
        }else if(PermitUtil.getPermit(token)==0){
    ...
    public ResponseData getStuBySex(@PathVariable("sex") Integer sex,HttpServletRequest request) {
        String token  = request.getHeader("token");
        if(PermitUtil.getPermit(token)==2){
            return new ResponseData(ExceptionMsg.PERMISSION,null);
        }else if(PermitUtil.getPermit(token)==0){
    ...
    public ResponseData getStuBySex(@PathVariable("email") String email,HttpServletRequest request) {
        String token  = request.getHeader("token");
        if(PermitUtil.getPermit(token)==2){
            return new ResponseData(ExceptionMsg.PERMISSION,null);
        }else if(PermitUtil.getPermit(token)==0){
    ...
    @PostMapping("/del/{id}")
    public ResponseData del(@PathVariable("id") Integer id,HttpServletRequest request) {
        String token  = request.getHeader("token");
        if(PermitUtil.getPermit(token)==2){
            return new ResponseData(ExceptionMsg.PERMISSION,null);
        }else if(PermitUtil.getPermit(token)==0){
    ...
    @PostMapping("/editer")
    public ResponseData editStu(@RequestBody Stu stu,HttpServletRequest request) {
        String token  = request.getHeader("token");
        if(PermitUtil.getPermit(token)==2){
            return new ResponseData(ExceptionMsg.PERMISSION,null);
        }else if(PermitUtil.getPermit(token)==0){
    ...
    @PostMapping("/addone")
    public ResponseData addStu(@RequestBody Stu stu,HttpServletRequest request) {
        String token  = request.getHeader("token");
        if(PermitUtil.getPermit(token)==2){
            return new ResponseData(ExceptionMsg.PERMISSION,null);
        }else if(PermitUtil.getPermit(token)==0){
