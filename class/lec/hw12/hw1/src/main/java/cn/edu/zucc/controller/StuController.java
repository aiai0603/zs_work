...
public class StuController {
    ...
    public ResponseData getStu(@PathVariable("id") Integer id) {
    ...
    public ResponseData getStu(@PathVariable("sid") String sid ) {
    ...
    public ResponseData getStuBySex(@PathVariable("sex") Integer sex) {
    ...
    public ResponseData getStuBySex(@PathVariable("email") String email) {
    ...
    @PostMapping("/editer")
    public ResponseData editStu(@RequestBody Stu stu) {
    ...
    @PostMapping("/addone")
    public ResponseData addStu(@RequestBody Stu stu) {
        ...
        String msg = "欢迎新朋友： "+reSex+" "+stu.getName()+" 学号："+ stu.getSid();
        sender.send2(msg);
